						...
						?>
							...
							<li class="header-account dropdown default-dropdown" style="min-width: 200px">
								<div class="dropdown-toggle" role="button" data-toggle="dropdown" aria-expanded="true" style="display: flex; align-items: center;">
									...
									<?php } else { ?>
										<div class="header-btns-icon">
											<img src="./gambar/user/<?php echo $c['customer_foto'] ?>" class="user-image" style="width: 40px; height: 40px; object-fit: cover; object-position: top; top; margin-right: 10px;">
										</div>
									<?php } ?>
									<div>
										<strong class="text-uppercase"><?php echo $c['customer_nama']; ?> <i class="fa fa-caret-down"></i></strong>
										<span style="display: block;"><?php echo $c['customer_email']; ?></span>
									</div>
								</div>
								<ul class="custom-menu">
									...
									<li><a href="customer_profile.php?id=<?php echo $c['customer_id'] ?>"><i class="fa fa-edit"></i> Edit Profile</a></li>
