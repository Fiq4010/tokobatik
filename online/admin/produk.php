                  ...
                  while($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                      ...
                      <td>                        
                        ...
                        <a class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data produk ini?')" href="produk_hapus.php?id=<?php echo $d['produk_id'] ?>"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php 
                  }
