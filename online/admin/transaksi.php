                      ...
                      <td class="text-center">
                        <form action="transaksi_status.php" method="post">
                          ...
                          <select name="status" id="" class="form-control" onchange="form.submit()">
                            ...
                            <option <?php if($i['invoice_status'] == "2"){echo "selected='selected'";} ?> value="2">Ditolak / Dibatalkan</option>
                            <option <?php if($i['invoice_status'] == "3"){echo "selected='selected'";} ?> value="3">Dikonfirmasi & Diproses</option>
                            <option <?php if($i['invoice_status'] == "4"){echo "selected='selected'";} ?> value="4">Dikirim</option>
                            <!-- <option <?php if($i['invoice_status'] == "5"){echo "selected='selected'";} ?> value="5">Diterima</option> -->
                            <!-- <option <?php if($i['invoice_status'] == "6"){echo "selected='selected'";} ?> value="6">Pengajuan Refund</option> -->
                            <!-- <option <?php if($i['invoice_status'] == "7"){echo "selected='selected'";} ?> value="7">Refund</option> -->
                          </select>
                        </form>
                      </td>
                      <td class="text-center">    
