                    ...
                    <tr>
                      ...
                      <td>                      
                        <?php if($d['kategori_id'] != 1){ ?>  
                          ...
                          <a class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data kategori ini?')" href="kategori_hapus_konfir.php?id=<?php echo $d['kategori_id'] ?>"><i class="fa fa-trash"></i></a>
                        <?php } ?>
                      </td>
                    </tr>
                    <?php 
