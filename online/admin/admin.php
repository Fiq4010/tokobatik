                  ...
                  while($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                      ...
                      <td>                        
                        ...
                        <?php if($d['admin_id'] != 1){ ?>
                          <a class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data admin ini?')" href="admin_hapus.php?id=<?php echo $d['admin_id'] ?>"><i class="fa fa-trash"></i></a>
                        <?php } ?>
                      </td>
                    </tr>
                    <?php 
