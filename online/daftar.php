						...
						<div class="col-lg-6 col-lg-offset-3">
							...
							<form action="daftar_act.php" method="post" enctype="multipart/form-data">
								...
								<div class="text-center" style="margin-top: -5px;">
									<span>Sudah punya akun? </span><a href="masuk.php" class="text-primary font-weight-bold" style="text-decoration: none;" onmouseover="style='text-decoration: underline';" onmouseout="style='text-decoration: none';">Login sekarang</a>
								</div>
							</form>
