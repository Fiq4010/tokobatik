                                ...
                                <table class="shopping-cart-table table">
                                    ...
                                    <tbody>
                                        ...
                                        for ($a = 0; $a < $jumlah_isi_keranjang; $a++) {
                                            ...
                                            $ukuran_baju = $_SESSION['keranjang'][$a]['ukuran'];
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                <td class="thumb" id="keranjang">
                                                    <!-- <input type="checkbox" style="margin-right: 10px;" name="checkout" value="<?php echo $i['produk_id']; ?>"> -->
                                                ...
                                                <td class="text-center">
                                                    <strong><?php echo $ukuran_baju; ?></strong>
                                                </td>
                                                ...
                                                <td class="qty text-center">
                                                    ...
                                                    <input name="ukuran[]" value="<?php echo $ukuran_baju; ?>" type="hidden">
                                                ...
                                                <td class="text-right"><a class="main-btn icon-btn" href="keranjang_hapus.php?id=<?php echo $i['produk_id']; ?>&ukuran=<?php echo $ukuran_baju; ?>&redirect=keranjang"><i class="fa fa-close"></i></a></td>
                                            </tr>
